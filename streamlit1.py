...
.big-font { font-family: 'Bebas Neue', sans-serif; font-size: 100px !important; font-weight: 100; color: #3e4047; display: inline-block; max-width: 50%; margin: 0 auto; margin-top: -10px; } /* Adjusted */
.big2-font { font-family: 'Bebas Neue', sans-serif; font-size: 64px !important; font-weight: 100; color: #3e4047; display: inline-block; margin-bottom: 0px; margin-top: -1px; } /* Adjusted */
.med2-font { font-family: 'Bebas Neue', sans-serif; font-size: 32px !important; font-weight: 100; color: #D09E55; margin-top: -1px; } /* Adjusted */
