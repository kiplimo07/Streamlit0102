...
.big2-font { font-family: 'Bebas Neue', sans-serif; font-size:70px !important; font-weight: 100; color: #505357 ; display: inline-block; margin-bottom: 0px; }
...
.small-font { font-family: 'Lato', sans-serif; font-size:45px !important; color: #505357; }
