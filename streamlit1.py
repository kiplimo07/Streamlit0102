...
# The rest of your code for other pages...
 ...
 col1, col2 = st.columns([1, 1])
    ...
    # Insert code for generating and displaying heatmap and graphs
    # [Your heatmap and graph plotting code here]
    # For demonstration, adding placeholders for heatmap and graphs
    ...
    # Assuming event_1_data and event_2_data are defined as per your previous content
    ...
    # Add other plots as per your analysis
    plt.tight_layout()
    st.pyplot(fig)
    # Result
    st.subheader("Result")
