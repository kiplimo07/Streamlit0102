...
<style>
  .reportview-container .main .block-container { padding-right: 20% !important; }
    ...
    .big-font { font-family: 'Bebas Neue', sans-serif; font-size: 120px !important; font-weight: 100; color: #3b3f24; display: inline-block; max-width: 80%; margin: 0 auto; }
...
if page == "Welcome":
    ...
    with col1:
        st.image('https://github.com/jasonchang0102/Streamlit0102/raw/main/333', width=550)
    ...
    with col1:
        st.image('https://github.com/jasonchang0102/Streamlit0102/raw/main/777', caption='Distribution of Spending Across Skill Brackets', width=550)

    with col2:
        st.image('https://github.com/jasonchang0102/Streamlit0102/raw/main/111', caption='Day-by-Day Churn Rate: Event 1 vs Event 2', width=550)
    ...
    st.image('https://github.com/jasonchang0102/Streamlit0102/raw/main/3333', width=1000)
...
Streamline the quarterly royalty management process, reducing time spent by financial analysts from a month-long task to a 2-hour automated process.
    ...
    st.image('https://github.com/jasonchang0102/Streamlit0102/raw/main/9999', width=900)
...
if page == "Scope of Skills":
    ...
    st.subheader("- **Email:** [jason.chang01022021@gmail.com](mailto:jason.chang01022021@gmail.com)")
    st.subheader("- **LinkedIn:** [linkedin.com/in/jchang0102](https://linkedin.com/in/jchang0102)")
    st.subheader("- **Location:** Irvine CA")
