...
<style>
    /* Header styles */
    .big-font { font-family: 'Bebas Neue', sans-serif; font-size: 110px !important; font-weight: 100; color: #FFFFF; }
    .big2-font { font-family: 'Bebas Neue', sans-serif; font-size: 70px !important; font-weight: 100; color: #FFFFF; }
