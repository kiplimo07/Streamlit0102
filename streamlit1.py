...
if page == "SCOPE OF SKILLS":
    ...
    st.image('https://github.com/jasonchang0102/Streamlit0102/raw/main/Picture/edx', width=800)
     ...
     st.header("""IN GOD WE TRUST; FOR ALL ELSE, WE TURN TO THE VALIDATION OF DATA. WITH DATA SCIENCE AS OUR COMPASS, WE'RE SET TO REVEAL HIDDEN INSIGHTS THAT OUR DATA IS JUST DYING TO TELL. --J. CHANG
            """)
